  ...
  try {
    ...
    return (
            ...
            <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
                ...
                <input type="text" placeholder='Type here' onChange={(e)=>setTitle(e.target.value)} className='w-full max-w-lg mt-2 p-2 border border-gray-300 rounded outline-none' required value={title}/>
                <p className='mt-4'>
                    Sub Title
                </p>
                <input type="text" placeholder='Type here' onChange={(e)=>setSubTitle(e.target.value)} className='w-full max-w-lg mt-2 p-2 border border-gray-300 rounded outline-none' required value={subTitle}/>
